...
1. [[hs-search-app.netlify.app/]([https://hs-search-app.netlify.app/](https://cheerful-sable-9671a2.netlify.app/))](https://cheerful-sable-9671a2.netlify.app/) 에 접속하여, 원하는 검색어를 검색창에 입력합니다. [암,염,병으로 테스트가능]
